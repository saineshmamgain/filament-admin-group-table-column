...
foreach ($files as $file) {
    ...
    match (true) {
        str_contains($file, determineSeparator('src/GroupColumn.php')) => rename($file, determineSeparator('./src/' . $className . '.php')),
        str_contains($file, determineSeparator('src/SkeletonServiceProvider.php')) => rename($file, determineSeparator('./src/' . $className . 'ServiceProvider.php')),
        str_contains($file, determineSeparator('src/Facades/GroupColumn.php')) => rename($file, determineSeparator('./src/Facades/' . $className . '.php')),
